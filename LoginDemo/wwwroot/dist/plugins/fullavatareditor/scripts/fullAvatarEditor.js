function fullAvatarEditor() {
	var id				= 'fullAvatarEditor'			//flash文本的ID
	var file			= 'plugins/fullavatareditor/fullAvatarEditor.swf';		//flash文本的路径
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	var	expressInstall	= 'expressInstall.swf';			//expressInstall.swf的路径
	var	width			= 600;							//flash文本的宽度
	var	height			= 430;							//flash文本的高度
	var container		= id;							//装载flash文本的容器(如div)的id
	var flashvars		= {};
	var callback		= function(){};
	var heightChanged	= false;
	//智能获取参数，字符类型为装载flash文本的容器(如div)的id，第一个数字类型的为高度，第二个为宽度，第一个object类型的为参数对象，如此4个参数的顺序可随意。
